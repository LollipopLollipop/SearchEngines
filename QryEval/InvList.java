...
public class InvList {
  ...
  public HashMap<Integer, Integer> docTfMap = new HashMap<Integer, Integer>();
  ...
  /**
   *  Get the n'th document positions vector from the inverted list.
   *  @param n The index of the requested document.
   *  @return The internal document positions vector.
   *  Manually added by Ding Zhao
   */
  public Vector<Integer> getPositions(int n) {
