 ...
 * @throws Exception 
   */
  public TermVector(int docId, String fieldName) throws Exception {
    ...
    if(this.luceneTerms == null){
    	//System.out.println("this.luceneTerms for " + docId + "|" + fieldName + "is null");
    	throw new NullPointerException("this.luceneTerms for " + docId + "|" + fieldName + " is null");
    }
